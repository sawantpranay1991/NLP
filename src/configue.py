...
def get_main_params():
    ...
    parser.add_argument('--model_name', dest='model_name', type=str, default=C.LM_QUESTION_ANSWERS)
    ...
    parser.add_argument('--save_dir', dest='save_dir', type=str, default=C.SAVE_DIR_PATH)
    parser.add_argument('--attn_architecture', dest='attn_architecture', type=str, default='dot')
...
def get_model_params(model_name):
    ...
    add_arg(parser, str, C.ATTENTION_ARCHITECTURE, H)
